      ...
      "destroy": {
        ...
        "split": {
          ...
          "particles": {
            ...
            "color": {
              value: [
                TWindConfig.theme.colors.red,
                TWindConfig.theme.colors.orange,
                TWindConfig.theme.colors.yellow,
                TWindConfig.theme.colors.green,
                TWindConfig.theme.colors.blue,
                TWindConfig.theme.colors.indigo,
